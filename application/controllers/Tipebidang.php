...
class TipeBidang extends CI_Controller {
    ...
    public function index()
	{
		$data = [
			...
			'judul'	=> 'Tipe Bidang',
			'subjudul'=> 'Data Tipe Bidang'
		];
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('relasi/tipebidang/data');
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Tipe Bidang',
			'subjudul'	=> 'Tambah Data',
			'matkul'	=> $this->master->getMatkul()
		];
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('relasi/tipebidang/add');
		$this->load->view('_templates/dashboard/_footer.php');
	}
	...
	public function edit($id)
	{
		...
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('relasi/tipebidang/edit');
		$this->load->view('_templates/dashboard/_footer.php');
	}
