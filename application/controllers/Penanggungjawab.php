...
class Penanggungjawab extends CI_Controller
{
	...
	public function index()
	{
		$data = [
			...
			'subjudul' => 'Data Penanggung Jawab'
		];
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('master/penanggungjawab/data');
	...
	public function add()
	{
		$data = [
			'user' => $this->ion_auth->user()->row(),
			'judul'	=> 'Tambah Penanggung Jawab',
			'subjudul' => 'Tambah Data Penanggung Jawab',
			'matkul'	=> $this->master->getAllMatkul()
		];
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('master/penanggungjawab/add');
		$this->load->view('_templates/dashboard/_footer.php');
	}
	...
	public function edit($id)
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Edit Penanggung Jawab',
			'subjudul'	=> 'Edit Data Penanggung Jawab',
			'matkul'	=> $this->master->getAllMatkul(),
			'data' 		=> $this->master->getDosenById($id)
		];
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('master/penanggungjawab/edit');
		$this->load->view('_templates/dashboard/_footer.php');
	}
	...
	public function save()
	{
		...
		$this->form_validation->set_rules('nama_dosen', 'Nama', 'required|trim|min_length[3]|max_length[50]');
		$this->form_validation->set_rules('email', 'Email', 'required|trim|valid_email' . $u_email);
		$this->form_validation->set_rules('matkul', 'Bidang', 'required');
	...
	public function import($import_data = null)
	{
		...
		$this->load->view('master/penanggungjawab/import');
	...
	public function do_import()
	{
		...
		if ($save) {
			...
			redirect('penanggungjawab/import');
		}
	}
}
