...
class UnitPenanggungjawab extends CI_Controller {
    ...
    public function index()
	{
		$data = [
			...
			'judul'	=> 'Unit Penanggung Jawab',
			'subjudul'=> 'Data Unit Penanggung Jawab'
		];
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('relasi/unitpenanggungjawab/data');
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Unit Penanggung Jawab',
			'subjudul'	=> 'Tambah Data',
			'dosen'		=> $this->master->getAllDosen(),
			'kelas'	    => $this->master->getAllKelas()
		];
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('relasi/unitpenanggungjawab/add');
		$this->load->view('_templates/dashboard/_footer.php');
	}
	...
	public function edit($id)
	{
		$data = [
			'user' 			=> $this->ion_auth->user()->row(),
			'judul'			=> 'Edit Unit Penanggung Jawab',
			'subjudul'		=> 'Edit Data',
		...
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('relasi/unitpenanggungjawab/edit');
		$this->load->view('_templates/dashboard/_footer.php');
	}
