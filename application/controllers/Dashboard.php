...
class Dashboard extends CI_Controller {
	...
	public function index()
	{
		...
		} elseif ( $this->ion_auth->in_group('Verifikator') || $this->ion_auth->in_group('Creator') || $this->ion_auth->in_group('Tester') || $this->ion_auth->in_group('Unit') || $this->ion_auth->in_group('Kepegawaian') ) {
