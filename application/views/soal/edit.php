                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <label for="kelas_id" class="control-label">Ruangan</label>
                                <select name="kelas_id" id="kelas_id" class="select2 form-group" style="width:100% !important">
                                    <option selected>Semua Ruangan</option>
                                    <?php
                                    $sdm = $soal->kelas_id;
                                    foreach ($kelas as $d) :
                                        $dm = $d->kelas_id;?>
                                        <option <?=$sdm===$dm?"selected":"";?> value="<?=$dm?>"><?=$d->nama_kelas?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
