<?=form_open_multipart('informasi/imut/save', array('id'=>'formdata'), array('method'=>'add'));?>
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Form Tambah Indikator Mutu</h3>
        <div class="box-tools pull-right">
            <a href="<?=base_url()?>informasi/imut" class="btn btn-sm btn-flat btn-warning">
        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                <div class="form-group">
                    ...
                    <input required="required" name="nama" placeholder="Nama" id="nama" class="form-control">
