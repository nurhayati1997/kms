    ...
    <div class="box-body">
        <div class="mt-2 mb-4">
            <?php if ( !$this->ion_auth->in_group('Verifikator') ) : ?>
                <a href="<?= base_url('informasi/ppi/add') ?>" class="btn btn-sm bg-purple btn-flat"><i class="fa fa-plus"></i> Tambah Data</a>
            <?php endif; ?>
        ...
        <?= form_open('informasi/ppi/delete', array('id' => 'bulk')) ?>
        <table id="ppi" class="w-100 table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Kegiatan</th>
...
<script src="<?= base_url() ?>assets/dist/js/app/informasi/ppi/data.js"></script>