    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                <?=form_open('karyawan/save', array('id'=>'mahasiswa'), array('method'=>'add'))?>
                    <div class="form-group">
                        <label for="nim">Id Karyawan</label>
                        <input autofocus="autofocus" onfocus="this.select()" placeholder="ID Karyawan" type="text" name="nim" class="form-control">
...
<script src="<?=base_url()?>assets/dist/js/app/master/karyawan/add.js"></script>