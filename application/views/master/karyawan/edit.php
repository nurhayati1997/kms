<div class="box">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <a href="<?=base_url('karyawan')?>" class="btn btn-sm btn-flat btn-warning">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                <?=form_open('karyawan/save', array('id'=>'mahasiswa'), array('method'=>'edit', 'id_mahasiswa'=>$mahasiswa->id_mahasiswa))?>
                    <div class="form-group">
                        <label for="nim">Id</label>
                        <input value="<?=$mahasiswa->nim?>" autofocus="autofocus" onfocus="this.select()" placeholder="ID Karyawan" type="text" name="nim" class="form-control">
...
<script src="<?=base_url()?>assets/dist/js/app/master/karyawan/edit.js"></script>