            ...
            <div class="col-sm-offset-3 col-sm-6 col-lg-offset-4 col-lg-4">
                <div class="my-2">
                    <div class="form-horizontal form-inline">
                        <a href="<?=base_url('tipe')?>" class="btn btn-default btn-xs">
                ...
                <?=form_open('tipe/save', array('id'=>'jurusan'), array('mode'=>'edit'))?>
...
<script src="<?=base_url()?>assets/dist/js/app/master/tipe/edit.js"></script>