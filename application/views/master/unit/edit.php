            ...
            <div class="col-sm-offset-3 col-sm-6">
                <div class="my-2">
                    <div class="form-horizontal form-inline">
                        <a href="<?=base_url('unit')?>" class="btn btn-default btn-xs">
                ...
                <?=form_open('unit/save', array('id'=>'kelas'), array('mode'=>'edit'))?>
...
<script src="<?=base_url()?>assets/dist/js/app/master/unit/edit.js"></script>