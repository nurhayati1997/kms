<?=form_open('penanggungjawab/save', array('id'=>'formdosen'), array('method'=>'edit', 'id_dosen'=>$data->id_dosen));?>
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Form <?=$subjudul?></h3>
        <div class="box-tools pull-right">
            <a href="<?=base_url()?>penanggungjawab" class="btn btn-sm btn-flat btn-warning">
        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <div class="form-group">
                    ...
                    <input value="<?=$data->nama_dosen?>" type="text" class="form-control" name="nama_dosen" placeholder="Nama">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
...
<script src="<?=base_url()?>assets/dist/js/app/master/penanggungjawab/edit.js"></script>