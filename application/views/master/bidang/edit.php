            ...
            <div class="col-sm-offset-4 col-sm-4">
                <div class="my-2">
                    <div class="form-horizontal form-inline">
                        <a href="<?=base_url('bidang')?>" class="btn btn-default btn-xs">
                ...
                <?=form_open('bidang/save', array('id'=>'matkul'), array('mode'=>'edit'))?>
...
<script src="<?=base_url()?>assets/dist/js/app/master/bidang/edit.js"></script>