<div class="box">
    ...
    <div class="box-body">
        ...
        <table id="poli" class="w-100 table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Nama Poli</th>
...
<div class="modal fade" id="myModal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
            ...
            <?=form_open('poli/add', array('id', 'tambah'));?>
...
<script src="<?=base_url()?>assets/dist/js/app/master/poli/data.js"></script>