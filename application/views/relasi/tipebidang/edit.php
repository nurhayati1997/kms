<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <a href="<?=base_url()?>tipebidang" class="btn btn-warning btn-flat btn-sm">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                    <?=form_open('tipebidang/save', array('id'=>'jurusanmatkul'), array('method'=>'edit', 'matkul_id'=>$id_matkul))?>
...
<script src="<?=base_url()?>assets/dist/js/app/relasi/tipebidang/edit.js"></script>