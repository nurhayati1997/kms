<div class="box">
    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-4">
                <?=form_open('unitpenanggungjawab/save', array('id'=>'kelasdosen'), array('method'=>'add'))?>
...
<script src="<?=base_url()?>assets/dist/js/app/relasi/unitpenanggungjawab/add.js"></script>