<div class="box">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <a href="<?=base_url()?>unitpenanggungjawab" class="btn btn-warning btn-flat btn-sm">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                <?=form_open('unitpenanggungjawab/save', array('id'=>'kelasdosen'), array('method'=>'edit', 'dosen_id'=>$id_dosen))?>
...
<script src="<?=base_url()?>assets/dist/js/app/relasi/unitpenanggungjawab/edit.js"></script>