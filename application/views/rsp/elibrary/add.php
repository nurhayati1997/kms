<?=form_open_multipart('rsp/elibrary/save', array('id'=>'formdata'), array('method'=>'add'));?>
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Form Tambah E-Librray</h3>
        <div class="box-tools pull-right">
            <a href="<?=base_url()?>rsp/elibrary" class="btn btn-sm btn-flat btn-warning">
