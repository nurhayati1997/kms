<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Master Data Diklat</h3>
    ...
    <div class="box-body">
        <div class="mt-2 mb-4">
            <?php if ( !$this->ion_auth->in_group('Verifikator') ) : ?>
                <a href="<?= base_url('rsp/diklat/add') ?>" class="btn btn-sm bg-purple btn-flat"><i class="fa fa-plus"></i> Tambah Data</a>
            <?php endif; ?>
        ...
        <?= form_open('rsp/diklat/delete', array('id' => 'bulk')) ?>
        <table id="diklat" class="w-100 table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Keterangan</th>
...
<script src="<?= base_url() ?>assets/dist/js/app/rsp/diklat/data.js"></script>