<?=form_open_multipart('rsp/litbang/save', array('id'=>'formdata'), array('method'=>'add'));?>
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Form Tambah Litbang</h3>
        <div class="box-tools pull-right">
            <a href="<?=base_url()?>rsp/litbang" class="btn btn-sm btn-flat btn-warning">
        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                <div class="form-group">
                    ...
                    <input required="required" name="nama" placeholder="Nama File" id="nama" class="form-control">
                ...
                <div class="form-group">
                    <label for="file" class="control-label">File <small>( pdf )</small></label>
