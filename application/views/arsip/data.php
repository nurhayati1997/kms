<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Master Data Arsip</h3>
    ...
    <div class="box-body">
        <div class="mt-2 mb-4">
            <?php if ( !$this->ion_auth->in_group('Verifikator') ) : ?>
                <a href="<?= base_url('arsip/add') ?>" class="btn btn-sm bg-purple btn-flat"><i class="fa fa-plus"></i> Tambah Data</a>
            <?php endif; ?>
        ...
        <?= form_open('arsip/delete', array('id' => 'bulk')) ?>
