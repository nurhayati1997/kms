<?=form_open_multipart('arsip/verify', array('id'=>'formdata'), array('id_arsip'=>$arsip->id_arsip));?>
<div class="box">
    <div class="box-header with-header">
        <h3 class="box-title">Detail Informasi</h3>
        <div class="pull-right">
            <a href="<?=base_url()?>arsip" class="btn btn-xs btn-flat btn-default">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                <h3 class="text-center">Informasi Arsip</h3>
                <br>
                <strong>Nama File : </strong><?=$arsip->nama?>
                <br>
                <strong>Keterangan : </strong><?=$arsip->keterangan?>
                <br>
                ...
                <hr class="my-4">
                <strong>Dibuat pada : </strong> <?=date($arsip->created_date)?>
                <br>
                <strong>Terkahir diupdate : </strong> <?= ((date($arsip->updated_date))!=null) ? date($arsip->updated_date) : '-'?>
            </div>
            <?php if ( $this->ion_auth->is_admin() || $this->ion_auth->in_group('Verifikator')) : ?>
            <div class="col-sm-12">
                <div class="form-group pull-right">
                    <input type = "hidden" id = "btn_submit" name = "btn_submit">
                    <?php if ($arsip->publish == 'False'):?>
                        <?php if($arsip->status == 'Denied'): ?>
                        ...
                        <?php elseif($arsip->status == 'Verified'): ?>
