<?=form_open_multipart('berita/save', array('id'=>'formdata'), array('method'=>'add'));?>
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Form Tambah Berita</h3>
        <div class="box-tools pull-right">
            <a href="<?=base_url()?>berita" class="btn btn-sm btn-flat btn-warning">
        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                <div class="form-group">
                    ...
                    <input required="required" name="nama" placeholder="Nama Berita" id="nama" class="form-control">
                    <small class="help-block" style="color: #dc3545"><?=form_error('nama')?></small>
                </div>
                <div class="form-group">
                    <label for="keterangan" class="control-label">Keterangan</label>
                    <textarea name="keterangan" id="keterangan" class="form-control summernote"><?=set_value('keterangan')?></textarea>
