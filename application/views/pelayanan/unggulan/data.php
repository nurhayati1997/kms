<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Master Data Pelayanan Unggulan</h3>
    ...
    <div class="box-body">
        <div class="mt-2 mb-4">
            <?php if ( !$this->ion_auth->in_group('Verifikator') ) : ?>
                <a href="<?= base_url('pelayanan/unggulan/add') ?>" class="btn btn-sm bg-purple btn-flat"><i class="fa fa-plus"></i> Tambah Data</a>
            <?php endif; ?>
        ...
        <?= form_open('pelayanan/unggulan/delete', array('id' => 'bulk')) ?>
...
<script src="<?= base_url() ?>assets/dist/js/app/pelayanan/unggulan/data.js"></script>