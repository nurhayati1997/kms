<?=form_open_multipart('pelayanan/unggulan/verify', array('id'=>'formdata'), array('id_pelayanan_unggulan'=>$data->id_pelayanan_unggulan));?>
<div class="box">
    <div class="box-header with-header">
        <h3 class="box-title">Detail Informasi</h3>
        <div class="pull-right">
            <a href="<?=base_url()?>pelayanan/unggulan" class="btn btn-xs btn-flat btn-default">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                <h3 class="text-center">Informasi Pelayanan Unggulan</h3>
                <?php if(!empty($data->file)): ?>
                    <div class="w-100">
                        <?= tampil_media('uploads/pelayanan/unggulan/'.$data->file); ?>
                    </div>
                <?php endif; ?>
                <strong>Nama Pelayanan Unggulan: </strong><?=$data->nama?>
                <br>
