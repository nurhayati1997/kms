<?=form_open_multipart('pelayanan/ranap/verify', array('id'=>'formdata'), array('id_pelayanan_ranap'=>$data->id_pelayanan_ranap));?>
<div class="box">
    <div class="box-header with-header">
        <h3 class="box-title">Detail Informasi</h3>
        <div class="pull-right">
            <a href="<?=base_url()?>pelayanan/ranap" class="btn btn-xs btn-flat btn-default">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                <h3 class="text-center">Informasi Pelayanan Rawat Inap</h3>
                <?php if(!empty($data->file)): ?>
                    <div class="w-100">
                        <?= tampil_media('uploads/pelayanan/ranap/'.$data->file); ?>
                    </div>
                <?php endif; ?>
