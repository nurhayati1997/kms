<?=form_open_multipart('pelayanan/penunjang/save', array('id'=>'formdata'), array('method'=>'add'));?>
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Form Tambah Data</h3>
        <div class="box-tools pull-right">
            <a href="<?=base_url()?>pelayanan/penunjang" class="btn btn-sm btn-flat btn-warning">
