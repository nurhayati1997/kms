<div class="row">
    <div class="col-sm-12">    
        <?=form_open_multipart('pelayanan/penunjang/save', array('id'=>'formdata'), array('method'=>'edit', 'id_pelayanan_penunjang'=>$data->id_pelayanan_penunjang));?>
        <div class="box">
                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="row">
                            ...
                            <div class="form-group pull-right">
                                <a href="<?=base_url('pelayanan/penunjang')?>" class="btn btn-flat btn-default"><i class="fa fa-arrow-left"></i> Batal</a>
