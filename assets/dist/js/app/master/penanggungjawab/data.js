...
$(document).ready(function() {
  ...
  table = $("#dosen").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: base_url + "penanggungjawab/data",
      type: "POST"
    },
    columns: [
      {
    ...
    columnDefs: [
      {
        ...
        render: function(data, type, row, meta) {
          ...
          return `<div class="text-center">
							<a href="${base_url}penanggungjawab/edit/${data.id_dosen}" class="btn btn-xs btn-warning">
  ...
  $("#dosen").on("click", ".btn-aktif", function() {
    ...
    $.ajax({
      url: base_url + "penanggungjawab/create_user",
      data: "id=" + id,
      type: "GET",
