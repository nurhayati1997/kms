...
$(document).ready(function() {
      ...
      },
      {
        ...
        render: function(data, type, row, meta) {
          return `<div class="text-center">
									<a href="${base_url}tipebidang/edit/${data}" class="btn btn-warning btn-xs">
  ...
  $("#bulk").on("submit", function(e) {
    if ($(this).attr("action") == base_url + "tipebidang/delete") {
      e.preventDefault();
...
function bulk_delete() {
  if ($("#jurusanmatkul tbody tr .check:checked").length == 0) {
    ...
    $("#bulk").attr("action", base_url + "tipebidang/delete");
    Swal({
      title: "Anda yakin?",
