...
$(document).ready(function() {
  ...
  table = $("#kelasdosen").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: base_url + "unitpenanggungjawab/data",
      type: "POST"
    },
    columns: [
      {
      ...
      },
      {
        ...
        render: function(data, type, row, meta) {
          return `<div class="text-center">
									<a href="${base_url}unitpenanggungjawab/edit/${data}" class="btn btn-warning btn-xs">
  ...
  $("#bulk").on("submit", function(e) {
    if ($(this).attr("action") == base_url + "unitpenanggungjawab/delete") {
      e.preventDefault();
...
function bulk_delete() {
  if ($("#kelasdosen tbody tr .check:checked").length == 0) {
    ...
    $("#bulk").attr("action", base_url + "unitpenanggungjawab/delete");
    Swal({
      title: "Anda yakin?",
